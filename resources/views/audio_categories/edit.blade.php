...
@section('content')
   ...
   <div class="content">
       ...
       <div class="box box-primary">
           <div class="box-body">
               <div class="row">
                   {!! Form::model($audioCategory, ['route' => ['admin.audioCategories.update', $audioCategory->id], 'method' => 'patch','enctype' =>'multipart/form-data']) !!}
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body panel-body-com-m">
                        ...
                        <label>Category Name : </label>
                           <input type="text" class="form-control1 control3" value="{{$audioCategory->title}}" name="title" required="true">

                           <label>Category Description : </label>
                           <textarea rows="3" class="form-control1 " name="desc" required="true">{{$audioCategory->desc}}</textarea>
