<div class="col-md-12 inbox_right">
            <div class="Compose-Message">
                <div class="panel panel-default">
                    <div class="panel-heading">
                       Manage Audio in {{$category->title}} Category
                    </div>
                    <div class="panel-body panel-body-com-m">
                        ...
                        <div class="com-mail">
                                ...
                                <div class="card-block">
                                    <div  class="row">
                                            <input type="hidden" name="audio_category_id" value="{{$category->id}}">
                                            <div class="col-lg-6">
                                             <label >Select Audio (.mp3)</label>
                                                 <input type="file"  name="file_path" class="form-control1" required="true" accept=".mp3">
                                         </div>
  ...
  <td>
  <a title="Edit document" href="{!! route('admin.audio.edit', [$document->id]) !!}" class="btn btn-default btn-xs"><i class="fa fa-pencil"></i></a>
  <a title="download file" href="{!! route('admin.audio.downloadFile', [$document->id]) !!}" class="btn btn-default btn-xs"><i class="fa fa-file"></i></a>
  <a title="delete document" href="{!! route('admin.audio.delete', [$document->id]) !!}" class="btn btn-danger btn-xs" onclick="return confirm('Are you sure?')"><i class="glyphicon glyphicon-remove"></i></a>
  </td>
            </tr>@endforeach
            </tbody>
            </table>
