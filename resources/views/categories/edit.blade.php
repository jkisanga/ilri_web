                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body panel-body-com-m">
                        ...
                        <label>Category Name : </label>
                           <input type="text" class="form-control1 control3" value="{{$category->name}}" name="name" required="true">

                           <label>Category Description : </label>
                           <textarea rows="3" class="form-control1 " name="desc" required="true">{{$category->desc}}</textarea>
